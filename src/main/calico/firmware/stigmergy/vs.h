...
typedef struct VsTuples {
    ...
    // Tuple metadata.
    uint64_t accessed; // Last timestamp when this tuple was accessed.
} VsTuple;
 ...
 */
extern float distanceTo(VsTuple tuple);
...
// be reserved for watched elements in the VS table.
#ifndef VS_SIZE_MIN_WATCHED
#define VS_SIZE_MIN_WATCHED VS_SIZE / VS_MIN_SIZE
#endif
